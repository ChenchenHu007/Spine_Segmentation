...
def pre_processing(dict_images):
    ...
    MR = crop_center(MR, list_landmarks[index], (160, 160))
    heatmap = crop_center(heatmap, list_landmarks[index], (160, 160))# the heatmap here is a tensor of (19, 12, 128,128),but only one is useful.
