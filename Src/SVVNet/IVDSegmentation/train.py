...
from DataLoader.dataloader_IVDSegmengtation import get_loader
...
if __name__ == '__main__':
    ...
    print('This script has been modified by MingHao Liu !')
    ...
    parser.add_argument('--model_path', type=str, default='../../../Output/Spine_Location/latest.pkl')
    ...
    trainer.setting.project_name = 'IVDSegmentation'
    trainer.setting.output_dir = '../../../Output/IVDSegmentation'
    ...
    trainer.setting.train_loader = get_loader(
        ...
        num_samples_per_epoch=args.batch_size * 130,
        num_works=4,
        phase='train'
    )
